      ...
      <nav>
        <div className="globalWrapper flex py-4 md:py-6 bg-white justify-between w-full px-7">
          ...
          <ul
            className={
              showNav
                ? "absolute left-0 top-full shadow-xl flex items-center justify-center w-full flex-col bg-white transition-all duration-00 z-[-1] lg:static lg:flex-row lg:opacity-100 lg:w-auto lg:z-[50]"
                : "absolute left-0 flex items-center justify-center w-full flex-col bg-white transition-all duration-00 z-[-1] lg:static lg:flex-row lg:opacity-100 lg:w-auto lg:z-[50] opacity-0 -translate-y-[400%] lg:translate-y-0"
            }
          >
