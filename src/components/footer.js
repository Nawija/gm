...
const Footer = () => (
  <footer className="mt-12 p-4 bg-gradient-to-tr from-orange-300 to-orange-400">
    <div className="globalWrapper px-8 py-4">
      <div className="flex flex-wrap items-center justify-between">
        <Link
          to="/"
          className="flex items-center gap-2.5 text-2xl font-serif text-orange-800 transition duration-300 "
          aria-label="logo"
        >
          <svg
        ...
        <div className="flex items-center justify-end w-full">
          <div className="flex items-center justify-center flex-col px-4">
            <p className="font-bold mb-2 text-lg md:text-xl mt-12 md:mt-0 text-orange-800">
              Kontakt
            </p>
            <a href="tel:+48570037077" className="hover:underline">
              Tel: +48 570-037-077
            </a>
            <a href="mailto:seovileo@gmail.com" className="hover:underline">
      ...
      <div className="flex items-center justify-between mt-8 pt-6 border-t-2 border-amber-100 font-coming">
        <Link to="/">
        ...
        <div className="flex">
          <p className="px-1 mx-1">F</p>
          <p className="px-1 mx-1">G</p>
          <p className="px-1 mx-1">I</p>
          <p className="px-1 mx-1">Y</p>
        </div>
      </div>
    </div>
  </footer>
